...
- **阶段**：V1 完成（2026-09-09）。核心正确性的洞都补上了。之后：**产品打磨** —— 手机比例这轮
  已收尾（M-1 #21 + M-2 #22 均合并）。App / 订阅方向因预算暂停（见下），先把产品本身做好。
- **`main`**：`5dbe3bd` —— typecheck / 769 测试 / build 全绿。
...
| #22 | 页面标题改口语化：4 个标题对齐侧栏名（Overview / Goals / Budget / Settings）+ 9 条副标题重写成一行大白话 | merged |
