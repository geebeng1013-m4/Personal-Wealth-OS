...
## 电脑版液态玻璃（DG 系列，DG-1..DG-4 已合并，DG-5 PR 待合并）
...
- **DG-5 完成（2026-09-16）**：电脑版侧栏变成悬浮玻璃面板，后面加了一层绿色和铜色的柔光；吸顶栏也改成悬浮，跟侧栏对齐。手机版不变。PR 待合并。
- **下一步**：DG 系列做完了。建议在真实电脑（Windows Chrome）和 iPhone 上整体检查一遍。
