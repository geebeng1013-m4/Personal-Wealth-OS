      ...
      <div class="login-card">
        ...
        <div class="login-body">
          <div class="login-pitch">
            <h2>Your money, investments and goals in one calm place.</h2>
            <p>WealthUp is a personal wealth tracker for young investors in Southeast Asia who build wealth with ETFs and monthly DCA.</p>
          </div>
          ...
          <p class="login-desc">Free. Your data syncs privately to your own account. For guidance only, not financial advice.</p>
        </div>
      </div>
      <!-- F-8: what WealthUp is, for a visitor deciding whether to sign in.
           Below the card on every screen, so the button stays in the first view. -->
